...
namespace aes
{
	...
	void cipher(std::vector<uint8_t>& in, std::vector<uint8_t>& out, std::vector<uint32_t>& dw);

	void inv_cipher(std::vector<uint8_t>& in, std::vector<uint8_t>& out, std::vector<uint32_t>& dw);
}
